...
`GET /doc` of opencode 1.18.30) is the source of truth for every wire type. This script
...
def emit_types() -> str:
    ...
    out.append("// Source: opencode-codes/tests/schemas/opencode_openapi.json (opencode 1.18.30).")
...
(OUT_DIR / "mod.rs").write_text(
    ...
    "//! `tests/schemas/opencode_openapi.json` (opencode 1.18.30). Do not edit by hand.\n"
    "\n"
    "pub mod samples;\n"
    "pub mod types;\n"
)
